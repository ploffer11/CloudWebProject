      ...
      <div>
        <nav class="red accent-2" role="navigation">
          <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
              <li>
                <Link class="waves-effect waves-light btn" to="/login">
                  Sign in<i class="material-icons right">cloud</i>
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div class="section no-pad-bot" id="index-banner">
          <div class="container">
            <br />
            <br />
            <h1 class="header center gray-text text-darken-4">
              Share Your Drive
            </h1>
            ...
            <div class="row">
              <div class="col s12 m4">
                <div class="icon-block">
                  <h2 class="center red-text text-accent-2">
